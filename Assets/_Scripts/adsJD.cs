...
public class adsJD : MonoBehaviour
{
    ...
    {
        return new AdRequest.Builder().Build();                 // if you want to customize the test advertisements then just remove .Build(); and uncomment the rest of the lines in the function
